package _05_TollTips

/**
 * [Tooltips]
 *
 * You can add tooltip to any components using TooltipArea. TooltipArea is similar to a Box, but with the ability to
 * show a tooltip.
 *
 * The main arguments of the TooltipArea function:
 *
 * >tooltip - composable content representing tooltip
 * >tooltipPlacement - describes how to place tooltip. You can specify an anchor (the mouse cursor or the component),
