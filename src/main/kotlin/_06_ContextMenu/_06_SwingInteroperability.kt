 ...
 * If you are embedding Compose into an existing application, you may want the text context menu to look the same as in
 * other parts of the application. To do this, there is JPopupTextMenu:
 */
